...
#colored_btn = ttk.Button(text="Test", style="C.TButton").pack()
        ...
        self.open_file = ttk.Button(self.parent, text="Browse...", command=self.browse_file,style="C.TButton") #see: def browse_file(self)
        self.open_file.grid(row=1, column=0, sticky=W, padx=(220, 6)) #put it beside the filelocation textbox
        #BUTTON TO PREVIEW SOUND FILE
        self.preview = Button(self.parent, text=">", command=self.play(self.filelocation.get()), bg="DarkRed", fg="black")
        ...
        self.compute = ttk.Button(self.parent, text="Compute", command=self.compute_model, style="C.TButton")
