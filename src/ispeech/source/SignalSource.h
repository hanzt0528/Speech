...
namespace vfx_ispeech
{
    ...
    struct Pet {
    Pet(FrequencyType sampleFrequency) { }
    std::string name;
  };

    class ISPEECH_EXPORT SignalSource
    {
    public:
	/**
	 ...
	 * The default constructor sets sample frequency to 0.
	 */
    SignalSource(std::size_t length):
    m_data(), m_sampleFrequency(0)
	{
    ...
    /*virtual std::size_t getSamplesCount1() const
	{
	    return m_data.size();
	}
    */
	 ...
	 *
	 * @param position sample index in the signal
	 * @param value set a new vaule at position
	 * @return void
	 */
	virtual void set(std::size_t position,double value)
	{
    ...
    virtual void shiftLeft(std::size_t position);
    /**
     ...
     * @return void
     */
    virtual void shiftRight(std::size_t position);
    /**
     ...
     * @return void
     */
    virtual void append(SignalSource & a);
     ...
     * @return void
     */
    virtual void appendHead(SignalSource & a);
